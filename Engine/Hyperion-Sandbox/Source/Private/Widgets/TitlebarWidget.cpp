...
{
    // Load images
    m_AppHeaderIcon = Hyperion::Texture2D::Create("Assets/Icons/Logo.png");
    m_IconMinimize = Hyperion::Texture2D::Create("Assets/Icons/Minimize.png");
    m_IconMaximize = Hyperion::Texture2D::Create("Assets/Icons/Maximize.png");
    m_IconRestore = Hyperion::Texture2D::Create("Assets/Icons/Restore.png");
    m_IconClose = Hyperion::Texture2D::Create("Assets/Icons/Close.png");
}

void TitlebarWidget::DrawUITitlebar()
{
    const auto& window = Hyperion::Application::Get().GetWindow();
    ...
    // Window buttons
    const ImU32 buttonColN = Hyperion::UI::Colors::ColorWithMultipliedValue(IM_COL32(192, 192, 192, 255), 0.9f);
    const ImU32 buttonColH = Hyperion::UI::Colors::ColorWithMultipliedValue(IM_COL32(192, 192, 192, 255), 1.2f);
    ...
    Hyperion::UI::ShiftCursorY(8.0f);
    {
        ...
        Hyperion::UI::DrawButtonImage(m_IconMinimize, buttonColN, buttonColH, buttonColP, Hyperion::UI::RectExpanded(Hyperion::UI::GetItemRect(), 0.0f, -padY));
    }
    ...
    Hyperion::UI::ShiftCursorY(8.0f);
    {
        ...
        Hyperion::UI::DrawButtonImage(isMaximized ? m_IconRestore : m_IconMaximize, buttonColN, buttonColH, buttonColP);
    }
    ...
    Hyperion::UI::ShiftCursorY(8.0f);
    {
        ...
        if (ImGui::InvisibleButton("Close", ImVec2(buttonWidth, buttonHeight)))
            Hyperion::Application::Get().Shutdown();

        Hyperion::UI::DrawButtonImage(m_IconClose, IM_COL32(192, 192, 192, 255), Hyperion::UI::Colors::ColorWithMultipliedValue(IM_COL32(192, 192, 192, 255), 1.4f), buttonColP);
    }
