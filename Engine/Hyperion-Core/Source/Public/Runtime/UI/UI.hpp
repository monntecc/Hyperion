...
namespace Hyperion::UI {
	...
	void HYPERION_API RenderWindowOuterBorders(ImGuiWindow* window);

	bool HYPERION_API UpdateWindowManualResize(ImGuiWindow* window, ImVec2& newSize, ImVec2& newPosition);

	bool HYPERION_API ButtonCentered(const char* label, const ImVec2& size = ImVec2(0, 0));

	// Utilities
	class HYPERION_API ScopedStyle
	{
	public:
	...
	class HYPERION_API ScopedColor
	{
	public:
	...
	class HYPERION_API ScopedColorStack
	{
	public:
	...
	class HYPERION_API ScopedStyleStack
	{
	public:
	...
	class HYPERION_API ScopedItemFlags
	{
	public:
	...
	void HYPERION_API DrawBorder(ImRect rect, float thickness = 1.0f, float rounding = 0.0f, float offsetX = 0.0f, float offsetY = 0.0f);
