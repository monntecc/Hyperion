...
#define HR_INTERNAL_ASSERT_NO_MSG(type, check) HR_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", HR_STRINGIFY_MACRO(check), ::Hyperion::Assert::CurrentFileName(__FILE__), __LINE__)
